...
this.driver.js = (function (F) {
    ...
    function xe(e, o) {
        ...
        const i = Date.now(),
            ...
            p = s(),
            c = l();
        (!f && a && a(r ? void 0 : n, d, { config: p, state: c, driver: k() }),
            g && g(w ? void 0 : e, o, { config: p, state: c, driver: k() }));
        const u = !f && v;
        let h = !1;
        (_e(),
            S('previousStep', d),
    ...
    function H() {
        ...
        (e && window.cancelAnimationFrame(e),
            S('__resizeTimeout', window.requestAnimationFrame(be)));
    }
    function Pe(e) {
        var r;
            ...
            U(
                ...
                (E) => {
                    ...
                    if (L.closest('.driver-popover-next-btn'))
                        return $
                            ? $(e, o, { config: s(), state: l(), driver: k() })
                            : T('nextClick');
                    if (L.closest('.driver-popover-prev-btn'))
                        return B
                            ? B(e, o, { config: s(), state: l(), driver: k() })
                            : T('prevClick');
                    if (L.closest('.driver-popover-close-btn'))
                        return R
                            ? R(e, o, { config: s(), state: l(), driver: k() })
                            : T('closeClick');
                },
                (E) =>
    ...
    function Ae(e = {}) {
        ...
        function v(a = 0) {
            ...
            const c = p[a],
                ...
                b = s('allowClose'),
                C =
                    typeof ((W = c.popover) == null ? void 0 : W.showProgress) != 'undefined'
                        ? (I = c.popover) == null
                            ? void 0
                            : I.showProgress
                        : s('showProgress'),
        ...
        function g(a = !0) {
            ...
            if (
                ...
                (m && m(C ? void 0 : p, c, { config: s(), state: l(), driver: k() }),
                    b && b(C ? void 0 : p, c, { config: s(), state: l(), driver: k() }));
            }
            u && u.focus();
        }
        const y = {
            ...
            highlight: (a) => {
                (r(),
                    G({
                        ...a,
                        popover: a.popover
                            ? { showButtons: [], showProgress: !1, progressText: '', ...a.popover }
                            : void 0,
                    }));
            },
            destroy: () => {
